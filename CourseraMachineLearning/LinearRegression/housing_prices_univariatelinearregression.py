...
J_theta = linearregression.compute_univariate_cost_function(X, theta, y)
...
theta, J = linearregression.gradient_descent_univariate(X, theta, y, number_of_iterations, alpha)
...
for index_theta0, val_theta0 in enumerate(theta0_values):
    for index_theta1, val_theta1 in enumerate(theta1_values):
        ...
        J[index_theta0, index_theta1] = linearregression.compute_univariate_cost_function(X, theta, y)
