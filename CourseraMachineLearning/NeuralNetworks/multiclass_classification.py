...
all_theta = neuralnetworks.one_vs_all(X_training, y_training, num_labels, lambda_for_regularization, OptimizationAlgo.FMIN_CG)

prediction_on_training_set = neuralnetworks.predict_outcome_for_digit_dataset(X_training, all_theta)
